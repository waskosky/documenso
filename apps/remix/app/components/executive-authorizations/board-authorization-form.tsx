...
export const BoardAuthorizationForm = ({
  ...
  if (templateVersion === 1) {
    return (
      <LegacyBoardAuthorizationForm
        defaultValues={defaultValues as Partial<BoardResolutionCertificatePayloadV1> & { notes?: null | string }}
  ...
  return (
    <CurrentBoardAuthorizationForm
      defaultValues={defaultValues as Partial<BoardResolutionCertificatePayload> & { notes?: null | string }}
      signerRoles={signerRoles}
    />
  );
};
...
const CurrentBoardAuthorizationForm = ({
  ...
  <>
    <Card className="p-6">
      <h2 className="font-semibold text-lg">Decision and organization</h2>
      <div className="mt-5 grid gap-5 md:grid-cols-2">
        <Field label="Action title" name="actionTitle" required defaultValue={defaultValues.actionTitle} />
        <Field
        ...
        />
        <Field label="Action date" name="actionDate" required type="date" defaultValue={defaultValues.actionDate} />
        <Field
    ...
    <Card className="mt-6 p-6">
      <h2 className="font-semibold text-lg">Decision record</h2>
      <div className="mt-5 grid gap-5">
        ...
        />
        <TextField label="Specific action" name="specificAction" required defaultValue={defaultValues.specificAction} />
        <TextField label="Specific terms (optional)" name="specificTerms" defaultValue={defaultValues.specificTerms} />
        <TextField
        ...
        <TextField label="Internal notes" name="notes" defaultValue={defaultValues.notes ?? undefined} />
      </div>
    </Card>

    <Card className="mt-6 p-6">
      <h2 className="font-semibold text-lg">Board signers</h2>
      <div className="mt-5">
...
const LegacyBoardAuthorizationForm = ({
  ...
  <>
    ...
    <Card className="mt-6 p-6">
      <h2 className="font-semibold text-lg">Board signers</h2>
      <div className="mt-5">
        <BoardRosterFields directors={defaultValues.directors} signerRoles={signerRoles} templateVersion={1} />
      </div>
    </Card>
  </>
);
